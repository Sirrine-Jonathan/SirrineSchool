...
import { BookOpen, Calculator, Keyboard, Award, Settings, Terminal, FlaskConical, Banknote } from 'lucide-react';
...
const Dashboard: React.FC = () => {
  ...
  const subjects = React.useMemo(() => [
    ...
    { id: 'money-market', name: 'Money Market', icon: Banknote, color: '#4caf50' },
