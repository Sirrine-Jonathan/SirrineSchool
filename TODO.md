- [x] Add a search/filter input at the top of the dashboard for fuzzy searching games.
- [x] Categorize each game (e.g., Math, Reading, Coding) and add filter pills/tags to the dashboard UI.
...
- [x] Show which games have been won on the dashboard.
- [x] Allow filtering to games that have not been won.
...
- [ ] Implement "Flag Finder" geography game.
